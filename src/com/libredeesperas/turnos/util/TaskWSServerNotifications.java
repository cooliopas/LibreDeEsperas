...
public class TaskWSServerNotifications extends AsyncTask<String,Integer,HashMap>{
	...
	public TaskWSServerNotifications(MainPresenter mainPresenter){
    ...
    protected HashMap doInBackground(String... params){
        ...
        try{
           ...
           //Actualiza el turno en el servidor
        	hmResultServer = mainPresenter.getWSServerNotifications(gcmCode);

        }catch (UxorException ex){
        	Log.d(TAG, "Error al recuperar las actualizaciones de servicios:" + ex.getMessage());
        }
	...
	protected void onPreExecute() {
        this.dialog.setMessage("Recuperando actualizaciones de servicios");
    ...
    protected void onPostExecute(HashMap hmServerResult) {
    	...
    	if ( (Boolean)hmServerResult.get("result") ){
    		...
    		hmServerResult.put("msg","Los servicios fueron actualizados correctamente!!!");
